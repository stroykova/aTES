...
if __name__ == '__main__':
    ...
    cur = con.cursor()
    create_table('users', ('username unique, balance default 0 not null',))
    create_table('tasks', ('id INTEGER PRIMARY KEY', 'description', 'assignee', 'initial_cost', 'done_cost', 'status', 'title', 'jira_id'))
